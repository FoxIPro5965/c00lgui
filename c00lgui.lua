--// c00lgui v0.4 (Black + Red Border + White Text) //--  
...
MainStroke.Color = Color3.fromRGB(255,0,0) -- viền đỏ
...
ModeStroke.Color = Color3.fromRGB(255,0,0)
...
ModeButton.MouseButton1Click:Connect(function()
    ...
    elseif mode == 3 then ModeButton.Text = "Mode: FLY" startFly()
    end
end)
...
FBStroke.Parent = FBButton
FBStroke.Color = Color3.fromRGB(255,0,0)
...
FBButton.MouseButton1Click:Connect(function()
    ...
    if fbOn then
        ...
        FBButton.TextColor3=Color3.fromRGB(0,255,0)
